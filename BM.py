...
class account(object):
    ...
    def create_account(self, s):  #function to get data from user
    ...
    def show_account(self, s):    #function to show data on screen
        print("\nAccount No. :", s.acno)
        print("\nAccount holder name: ", s.name)
        print("\nType of account", s.type)
        print("\nBalance amount: ", s.deposit)

    def modify(self, s):      #function to get new data from user
        print("\nAccount No. : ", s.acno)
    ...
    def dep(self, s, x):           #function to accept amount and add to balance
        s.deposit += x

    def draw(self, s, x):          #function to accept amount and subtract from balance amount
        s.deposit -= x

    def report(self, s):          #function to show data in tabular format
        print("%-10s"%s.acno,"%-20s"%s.name,"%-10s"%s.type,"%-6s"%s.deposit)

    def retacno(self, s):         #function to return account number
        return s.acno

    def retdeposit(self, s):      #function to return balance amount 
        return s.deposit

    def rettype(self, s):         #function to return type of account
        return s.type
